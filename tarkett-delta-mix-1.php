...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум бытовой «Tarkett» Delta Mix 1 цена от <?echo $min_price_lin_54?> ₽/м² купить в Стерлитамаке</title>
  <meta name="description" content="Купить в Стерлитамаке бытовой линолеум «Таркетт» Delta Mix 1 по цене от <?echo $min_price_lin_54?> руб/м² в магазине «СтройСити». Ширина линолеума: 3,0; 3,5 метра.">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="theme-color" content="#2b58cc">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/tarkett-delta-mix-1-original.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/tarkett-delta-mix-1-original.jpg">
  <meta name="twitter:image" content="https://str.city/assets/images/linoleum/tarkett-delta-mix-1-original.jpg">
  <meta property="og:image" content="https://str.city/assets/images/video/linoleum-tarkett-delta-mix-1-video-min.jpg">
  <link rel="image_src" href="https://str.city/assets/images/video/linoleum-tarkett-delta-mix-1-video-min.jpg">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/tarkett-delta-mix-1-v-magazine-stroycity-1.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/tarkett-delta-mix-1-v-magazine-stroycity-1.jpg">
  ...
  <meta property="og:image" content="https://str.city/assets/images/linoleum/bg-tarkett-linoleum-delta-mix-1.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/bg-tarkett-linoleum-delta-mix-1.jpg">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-tarkett-linoleum-delta-mix-1.jpg);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(12 12 12);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум бытовой<br>«Tarkett» Delta Mix 1</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить бытовой линолеум «Tarkett» из коллекции Delta шириной: <span class="otrez">3,0</span> <span class="otrez">3,5</span> метра.</p>
...
<div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-tarkett">Линолеум</a> / Линолеум «Tarkett» коллекция Delta название Mix 1</p>
<div class="media-container-row">
<div class="col-12 col-md-12">
<div class="media-container-row">
<div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Tarkett» Delta Mix 1</h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_54?></span> <span>Страна: Россия </span> <span>Производитель: <a class="text-black" href="/manufacturers/tarkett" target="_blank">Tarkett™</a></span> <span>Срок службы: 7 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_54?></span></div><img src="/assets/images/linoleum/tarkett-delta-mix-1.jpg" alt="Линолеум «Tarkett» Delta Mix 1" style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_54?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_54 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_54?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
          ...
          <table class="table">
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Превая цифра 2 означает класс применения «бытовой». Вторая цифра 1 означает с невысокой степенью нагрузки."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Класс применения</td>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Mix 1</td>
     </tr><tr>
...
<p class="mbr-text mbr-fonts-style display-6" style="padding-top: 25px;"><a href="/assets/images/qr/linoleum/qr-code-tarkett-delta-mix-1-big.gif" download><img src="/assets/images/qr/linoleum/qr-code-tarkett-delta-mix-1.gif" alt="QR-код на линолеум «Tarkett» Delta Mix 1 магазина «СтройСити» в Стерлитамаке"  style="-webkit-user-select: none; float:left; margin: 0 10px 0 0;"></a> <i>Адрес: г. Стерлитамак, ул. Западная, д. 18Д</i><br><span style="text-align: center;">✆ <a class="text-primary" href="tel:+73473201102">+7&nbsp;(3473)&nbsp;201&nbsp;102</a> ✆ <a class="text-primary" href="tel:+79177779184">+7&nbsp;(917)&nbsp;777&nbsp;91&nbsp;84</a></span></p>
        </div>
...
</div><p class="mbr-fonts-style panel-text display-6 pt-3">В магазине «СтройСити» продается бытовой <strong>линолеум «Tarkett» Delta Mix 1</strong> по цене от <?echo $min_price_lin_54?> руб/м² в Стерлитамаке, ширина <span class="alert-info">3,0</span> и <span class="alert-info">3,5</span> метров. Отрез и раскрой линолеума бесплатно по месту в магазине. Срок службы линолеума 7 лет. Страна производитель Россия. В нашем магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
<div class="youtube" id="iZBkw1eQU_4" data-params="modestbranding=0&amp;showinfo=0&amp;controls=1&amp;vq=hd1080" data-image="../../../assets/images/video/linoleum-tarkett-delta-mix-1-video-min.jpg" style="width: 100%; height: 608px; background-image: url(../../../assets/images/video/linoleum-tarkett-delta-mix-1-video-min.jpg);"><div class="play"></div></div>
          ...
          <div class="mbr-gallery-layout-default">
           <div>
            <div>
             ...
             <img src="/assets/images/linoleum/tarkett-delta-mix-1-v-magazine-stroycity-1-min.jpg" alt="Линолеум «Tarkett» в магазине «СтройСити» фото №1" style="-webkit-user-select: none">
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/tarkett-delta-mix-1-v-magazine-stroycity-1.jpg" alt="Линолеум «Tarkett» в магазине «СтройСити» фото №1" style="-webkit-user-select: none"></div>
...
<section class="order-form" id="buy">
 <div class="container">
  ...
  <div class="mbr-section-text mbr-white pb-3">
   ...
   <p class="mbr-text mbr-fonts-style display-6"><img src="/assets/images/qr/linoleum/qr-code-tarkett-delta-mix-1.gif" class="hide-on-mobile" alt="QR-код на линолеум «Tarkett» Delta Mix 1 магазина «СтройСити» в Стерлитамаке"  style="-webkit-user-select: none; float:left; margin: 0 10px 0 0;"> <i>Адрес: г. Стерлитамак, ул. Западная, д. 18Д</i><br><span style="text-align: center;">✆ <a class="text-primary" href="tel:+73473201102">+7&nbsp;(3473)&nbsp;201&nbsp;102</a> ✆ <a class="text-primary" href="tel:+79177779184">+7&nbsp;(917)&nbsp;777&nbsp;91&nbsp;84</a></span></p>
    </div>
   </div>
  </div>
 </div>
