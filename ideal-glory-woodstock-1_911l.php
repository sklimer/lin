...
<head>
  ...
  <title>Линолеум «Ideal» Glory WoodStock 1_911L полукоммерческий от <?echo $min_price_lin_12?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий линолеум «Идеал» Glory WoodStock 1_911L. Ширина линолеума: 1,5; 2,5; 3,0; 3,5; 4,0 метра, толщина покрытия 4,8 мм, а защитный слой составляет 0,4 мм.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-ideal-juteks-linoleum-ultra-cracked-oak-2-696l.jpg);">
 <div class="mbr-overlay" style="opacity: 0.1; background-color: rgb(43 88 204);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«iDEAL» Glory WoodStock 1_911L</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий<br>линолеум «IDEAL» из коллекции Glory шириной: <span class="otrez">1,5</span> <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-ideal">Линолеум</a> / Линолеум «Ideal» Glory WoodStock 1_911L</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «iDEAL» <span style="font-size:1.4rem;">Glory WoodStock 1_911L</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_12?></span> <span>Страна: Россия </span> <span>Бренд: <a class="text-black" href="/manufacturers/juteks#ideal" target="_blank">Ideal™</a> от <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_12?></span></div><img src="/assets/images/linoleum/ideal-glory-woodstock-1_911l.webp" alt="Линолеум «Ideal» Glory WoodStock 1_911L"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_12?> &#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_12 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_12?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
          ...
          <table class="table">
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Цифрs 23 означают, 2 — это бытовой класс, 3 — это высокая степень нагрузки. Цифра 32 означает класс применения «полукоммерческий», со средней степени нагрузки (вторая цифра 2)"><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Класс применения</td>
              ...
              <td class="body-item mbr-fonts-style display-7">3,1 мм</td>
             </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Cracked Oak 2_696L</td>
     </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">1,95&nbsp;кг</td>
     </tr>
    </tbody>
   </table>        
</div>
 ...
 <div style="padding-top: 10px;"><a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table">
    ...
    </div><p class="mbr-fonts-style panel-text display-6 pt-3">В магазине «СтройСити» в Стерлитамаке, продается <strong>линолеум «Ideal» Glory WoodStock 1_911L</strong> полукоммерческий со средней степени нагрузки, либо усиленный бытовой, цена от <?echo $min_price_lin_12?> до <?echo $max_price_lin_12?> руб/м² в зависимости от выбранной ширины. На выбор в наличии линолеум WoodStock 1_911L шириной <span class="alert-info">1,5</span> <span class="alert-info">2,5</span> <span class="alert-info">3,0</span> <span class="alert-info">3,5</span> <span class="alert-info">4,0</span> метра. Страна производитель Россия. Срок службы линолеума 15 лет. У нас в магазине можно не только купить линолеум, а также заказать раской либо отрез — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>

<p class="mbr-fonts-style panel-text display-8">Просматривая видео, рекомендуем выставлять качество <nobr>1080p60 HD</nobr>.</p>

<div class="youtube" id="XeIPc__Vh2k" data-params="modestbranding=0&amp;showinfo=0&amp;controls=1&amp;vq=hd1080" data-image="../../../assets/images/video/linoleum-ideal-glory-woodstock-1_911l-video.webp" style="width: 100%; height: 608px; background-image: url(../../../assets/images/video/linoleum-ideal-glory-woodstock-1_911l-video.webp);"><div class="play"></div></div>
