...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Ideal» Stars Canvas 697D полукоммерческий по цене <?echo $min_price_lin_16?> ₽/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Ютекс» Stars Canvas 697D, цена <?echo $min_price_lin_16?> руб/м². Ширина линолеума: 5,0 метров. Другие ширины линолеума Canvas 697D производитель не выпускает, но магазин может нарезать или раскроить по требуемой ширине">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-ideal-juteks-linoleum-stars-cracked-oak-1-016l.jpg);">
 <div class="mbr-overlay" style="opacity: .4; background-color: rgb(53, 46, 37);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«Ideal» Stars Canvas 697D</h1>
      <h2 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">Купить линолеум <a href="#price"><img async src="/assets/images/ideal-logo.png" alt="Бренд «Ideal» от компании «Juteks» — российский производитель напольных покрытий" style="margin-top: -2px;" style="-webkit-user-select: none"></a> Российского производителя</h2>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-ideal">Линолеум</a> / Линолеум «Ideal» Stars Canvas 697D</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Ideal» <span style="font-size:1.4rem;">Stars Canvas 697D</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_16?></span> <span>Страна: Россия </span> <span>Бренд: <a class="text-black" href="/manufacturers/juteks#ideal" target="_blank">Ideal<sup>&#x2122;</sup></a> от <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks<sup>&#x2122;</sup></a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><?echo $in_stock_lin_16?></div><img async src="/assets/images/linoleum/linoleum-ideal-stars-kansas-697d.jpg" alt="Линолеум «Ideal» Stars Canvas 697D" media-simple="true" style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_16?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_16 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_16?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Canvas 697D</td>
     </tr><tr>
