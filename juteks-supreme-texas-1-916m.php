...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум коммерческий «Juteks» Supreme Texas 1 916M цена от <?echo $min_price_lin_28?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="Магазин «СтройСити» в Стерлитамаке предлагает купить коммерческий линолеум «Ютекс» Supreme Texas 1 916M. Цена от <?echo $min_price_lin_28?> руб/м² в зависимости от выбранной ширины. Ширина линолеума: 5,0 метра">
  <meta name="keywords" content="линолеум стерлитамак, линолеум Juteks, купить, Supreme, Texas 1 916M, цена, коллекция, фотографии, видео, отзывы, вопросы ответы, характеристики">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/juteks-supreme-texas-1-916m-original.webp">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/juteks-supreme-texas-1-916m-original.webp">
  <meta name="twitter:image" content="https://str.city/assets/images/linoleum/juteks-supreme-texas-1-916m-original.webp">
  <meta property="og:image" content="https://str.city/assets/images/video/linoleum-juteks-supreme-texas-1-916m-video.webp">
  <link rel="image_src" href="https://str.city/assets/images/video/linoleum-juteks-supreme-texas-1-916m-video.webp">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-1.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-1.jpg">
  ...
  <meta property="og:title" content="Линолеум коммерческий «Juteks» Supreme Texas 1 916M цена от 1148,00 руб/м²">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://str.city/linoleum/juteks-supreme-texas-1-916m">
  <meta property="og:description" content="Купить коммерческий линолеум «Ютекс» Supreme Texas 1 916M. Цена от <?echo $min_price_lin_28?> руб/м² в зависимости от выбранной ширины. Ширина линолеума: 5,0 метра. Гарантия 10 лет">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="theme-color" content="#2b58cc">
  <link rel="canonical" href="https://str.city/linoleum/juteks-supreme-texas-1-916m">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-juteks-linoleum-supreme-barn-pine-631m.webp);">
 <div class="mbr-overlay" style="opacity: 0.2; background-color: rgb(23 22 20);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум коммерческий<br>«Juteks» Supreme Texas 1 916M</h1>
      <h2 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">Купить линолеум <a class="text-primary" href="#price"><img src="/assets/images/juteks-logo.png" alt="«Juteks» — российский производитель напольных покрытий" style="margin-top: -2px; -webkit-user-select: none"></a> Российского производителя</h2>
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить коммерческий<br>линолеум «Juteks» из коллекции Supreme шириной: <span class="otrez">5,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-juteks">Линолеум</a> / Линолеум «Juteks» Supreme Texas 1 916M</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Juteks» <span style="font-size:1.4rem;">Supreme Texas 1 916M</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_28?></span> <span>Страна: Бельгия </span> <span>Производитель: <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 10 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_28?></span></div><img src="/assets/images/linoleum/juteks-supreme-texas-1-916m.webp" alt="Линолеум «Juteks» Supreme Texas 1 916M"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_28?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_28 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_28?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
          ...
          <table class="table">
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7" style="width: 35%;"><span class="narezka">5,0</span></td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Цифра 23 означает бытовой класс применения с усиленной нагрузкой (вторая цифра 3) на линолеум. Цифра 32 означает класс применения «коммерческий», со средней степени нагрузки (вторая цифра 2). Цифра 41 означает класс применения «коммерческий», с низкой степени нагрузки (вторая цифра 1)."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Класс применения</td>
              <td class="body-item mbr-fonts-style display-7">23, 32, 41</td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7">2,9 мм</td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7" style="background: #fff;border-top: 0px;" colspan="2">Дополнительные технические характеристики и условия эксплуатации линолеума «Juteks» смотрите ниже.</td>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Supreme</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Название линолеума</td>
      <td class="body-item mbr-fonts-style display-7">Texas 1 916M</td>
     </tr><tr>
      ...
      <td class="body-item mbr-fonts-style display-7">Намотка стандартного рулона</td>
      <td class="body-item mbr-fonts-style display-7">28,0 м</td>
     </tr><tr>
      ...
      <td class="body-item mbr-fonts-style display-7">Дублированная</td>
     </tr>
    </tbody>
   </table>    
</div>
   ...
   <table class="table">
    ...
    <tbody>
     <tr>
      ...
      <td class="body-item mbr-fonts-style display-7">Абсолютная остаточная деформация</td>
      ...
      <td class="body-item mbr-fonts-style display-7">Живая структура, глубокий рельеф</td>
     </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Воспламеняемость (В)</td>
      <td class="body-item mbr-fonts-style display-7">В3</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Дымообразование (Д)</td>
      <td class="body-item mbr-fonts-style display-7">Д3</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Токсичность (Т)</td>
      <td class="body-item mbr-fonts-style display-7">Т2</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Распространение пламени (РП)</td>
          ...
          <div class="mbr-gallery-layout-default">
           <div>
            <div>
             ...
             <img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-1-min.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №1" style="-webkit-user-select: none">
             <span class="icon-focus"></span>
             <span class="mbr-gallery-title mbr-fonts-style display-7">Линолеум «Juteks» в магазине фото №1</span>
            </div>
           </div>
            <div class="mbr-gallery-item mbr-gallery-item--p5" data-video-url="false">
             <div href="#linolium-juteks" data-slide-to="1" data-toggle="modal">
             <img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-2-min.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №2" style="-webkit-user-select: none">
             <span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">Линолеум «Juteks» в магазине фото №2</span>
            </div>
           </div>
            <div class="mbr-gallery-item mbr-gallery-item--p5" data-video-url="false">
             <div href="#linolium-juteks" data-slide-to="2" data-toggle="modal">
              <img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-3-min.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №3" style="-webkit-user-select: none">
              <span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">Линолеум «Juteks» в магазине фото №3</span>
             </div>
            </div>
             <div class="mbr-gallery-item mbr-gallery-item--p5" data-video-url="false">
              <div href="#linolium-juteks" data-slide-to="3" data-toggle="modal">
             <img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-4-min.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №4" style="-webkit-user-select: none">
             <span class="icon-focus"></span><span class="mbr-gallery-title mbr-fonts-style display-7">Линолеум «Juteks» в магазине фото №4</span>
             </div>
            </div>
           </div>
          </div>
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-1.jpg" alt="Линолеум «Juteks » в магазине «СтройСити» фото №1" style="-webkit-user-select: none"></div>
             <div class="carousel-item"><img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-2.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №2" style="-webkit-user-select: none"></div>
              <div class="carousel-item"><img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-3.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №3" style="-webkit-user-select: none"></div>
               <div class="carousel-item active"><img src="/assets/images/linoleum/linolium-juteks-v-magazibe-stroycity-4.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №4" style="-webkit-user-select: none"></div></div>
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/vitrina-s-linoleumom-1.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №1" style="-webkit-user-select: none"></div>
             <div class="carousel-item"><img src="/assets/images/linoleum/vitrina-s-linoleumom-2.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №2" style="-webkit-user-select: none"></div>
               <div class="carousel-item active"><img src="/assets/images/linoleum/vitrina-s-linoleumom-3.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №3" style="-webkit-user-select: none"></div></div>
