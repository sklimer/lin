...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум полукоммерческий «Tarkett» Gladiator Miller 1 от <?echo $min_price_lin_48?> ₽/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Таркетт» Gladiator Miller 1 и минальная цена от <?echo $min_price_lin_48?> до <?echo $max_price_lin_48?> руб/м² в зависимости от выбора ширины. Ширина линолеума: 1,5; 2,5; 3,0; 3,5; 4,0 метра.">
  <meta name="keywords" content="линолеум Tarkett, линолеум полукоммерческий, линолеум Gladiator Miller 1, купить линолеум таркетт, линолеум стерлитамак">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/tarkett-gladiator-miller-1.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/tarkett-gladiator-miller-1.jpg">
  <meta name="twitter:image" content="https://str.city/assets/images/linoleum/tarkett-gladiator-miller-1.jpg">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/bg-tarkett-linoleum-gladiator-miller-1.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/bg-tarkett-linoleum-gladiator-miller-1.jpg">
  <meta property="og:title" content="Линолеум полукоммерческий «Tarkett» Gladiator Miller 1 купить в Стерлитамаке">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://str.city/assets/images/linoleum/tarkett-gladiator-miller-1.jpg">
  <meta property="og:description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Таркетт» Gladiator Miller 1, цена за 1 м² от <?echo $min_price_lin_48?> руб. Ширина линолеума: 1,5; 2,5; 3,0; 3,5; 4,0 метра. Магазин бесплатно предоставляет услугу — раскрой линолеума, купить линолеум можно любой ширины. Заказать линолеум можно с доставкой на дом. Гарантия 10 лет.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-tarkett-linoleum-gladiator-miller-1.jpg);">
 <div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(189, 183, 169);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«Tarkett» Gladiator Miller 1</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий линолеум «Tarkett» из коллекции Bonus шириной: <span class="otrez">1,5</span> <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-tarkett">Линолеум</a> / Линолеум «Tarkett» Gladiator Miller 1</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Tarkett» <span style="font-size:1.7rem;">Gladiator Miller 1</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_48?></span> <span>Страна: Россия </span> <span>Производитель: <a class="text-black" href="/manufacturers/tarkett" target="_blank">Tarkett™</a></span> <span>Срок службы: 10 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_48?></span></div><img src="/assets/images/linoleum/tarkett-gladiator-miller-1.jpg" alt="Линолеум «Tarkett» Gladiator Miller 1" style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">

<div itemscope itemtype="https://schema.org/Product">
<span itemprop="name">Линолеум полукоммерческий «Tarkett» Gladiator Miller 1</span>
<span itemprop="description">В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Таркетт» Gladiator Miller 1. Ширина линолеума: 1,5; 2,5; 3,0; 3,5; 4,0 метра. Магазин бесплатно предоставляет услугу — раскрой линолеума, купить линолеум можно любой ширины. Заказать линолеум можно с доставкой на дом. Гарантия 10 лет.</span>
...
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_48?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_48 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
</div>
</div>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_48?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
          ...
          <table class="table"  >
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7">4,5 мм</td>
             </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Gladiator</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Название линолеума</td>
      <td class="body-item mbr-fonts-style display-7">Miller 1</td>
     </tr><tr>
      ...
      <td class="body-item mbr-fonts-style display-7">20 (2,5 м);<br>20 (3,0 м);<br>20 (3,5 м);<br>20 (4,0 м).</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Дополнительное защитное покрытие (лак)</td>
      ...
      <td class="body-item mbr-fonts-style display-7">Дублированная основа</td>
     </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">&#x2264; 0,5г/100см²</td>
     </tr><tr>
      ...
      <td class="body-item mbr-fonts-style display-7">низкая</td>
     </tr><tr>
...
<p class="mbr-text mbr-fonts-style display-6" style="padding-top: 25px;"><a href="/assets/images/qr/linoleum/qr-code-tarkett-gladiator-miller-1.gif" download><img src="/assets/images/qr/linoleum/qr-code-tarkett-gladiator-miller-1.gif" alt="QR-код на линолеум «Tarkett» Gladiator Miller 1 магазина «СтройСити» в Стерлитамаке"  style="-webkit-user-select: none; float:left; margin: 0 10px 0 0;"></a> <i>Адрес: г. Стерлитамак, ул. Западная, д. 18Д</i><br><span style="text-align: center;">✆ <a class="text-primary" href="tel:+73473201102">+7&nbsp;(3473)&nbsp;201&nbsp;102</a> ✆ <a class="text-primary" href="tel:+79177779184">+7&nbsp;(917)&nbsp;777&nbsp;91&nbsp;84</a></span></p>
        </div>
...
</div><p class="mbr-fonts-style panel-text display-6" style="padding-top: 30px;">В магазине «СтройСити» в Стерлитамаке, продается полукоммерческий <strong>линолеум «Tarkett» Gladiator Miller 1</strong>, цена от <?echo $min_price_lin_48?> до <?echo $max_price_lin_48?> руб/м², зависит от выбранной ширины. Ширины на отрез от 1,5 до 4,0 метров, страна производителя Россия. Срок службы линолеума в жилых помещениях 10 лет. В нашем магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
...
<section class="order-form" id="buy">
 <div class="container">
  ...
  <div class="mbr-section-text mbr-white pb-3">
   <p class="mbr-text mbr-fonts-style display-6">В поле формы заказа укажите имя, телефон, сообщение, проверочный код и нажмите отправить. Будьте уверены, мы знаем, ваш выбор — <strong>линолеум «Tarkett» Gladiator Miller 1</strong>.</p>
   ...
   <p class="mbr-text mbr-fonts-style display-6"><img src="/assets/images/qr/linoleum/qr-code-tarkett-gladiator-miller-1.gif" class="hide-on-mobile" alt="QR-код на линолеум «Tarkett» Gladiator Miller 1 магазина «СтройСити» в Стерлитамаке"  style="-webkit-user-select: none; float:left; margin: 0 10px 0 0;"> <i>Адрес: г. Стерлитамак, ул. Западная, д. 18Д</i><br><span style="text-align: center;">✆ <a class="text-primary" href="tel:+73473201102">+7&nbsp;(3473)&nbsp;201&nbsp;102</a> ✆ <a class="text-primary" href="tel:+79177779184">+7&nbsp;(917)&nbsp;777&nbsp;91&nbsp;84</a></span></p>
    </div>
   </div>
  </div>
 </div>
