...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум полукоммерческий «Tarkett» Prestizh Texas 3 от <?echo $min_price_lin_49?> ₽/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Таркетт» Prestizh Texas 3. Ширина линолеума: 2,5; 3,0; 3,5; 4,0 метра.">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="theme-color" content="#2b58cc">
  <link rel="canonical" href="https://str.city/linoleum/tarkett-prestizh-texas-3">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-tarkett-linoleum-prestizh-texas-3.jpg);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(0, 0, 0);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«Tarkett» Prestizh Texas 3</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий линолеум «Tarkett» из коллекции Prestizh шириной: <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-tarkett">Линолеум</a> / Линолеум «Tarkett» коллекция Prestizh название Texas 3</p>
<div class="media-container-row">
<div class="col-12 col-md-12">
<div class="media-container-row">
<div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Tarkett» Prestizh Texas 3</h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_49?></span> <span>Страна: Россия </span> <span>Производитель: <a class="text-black" href="/manufacturers/tarkett" target="_blank">Tarkett<sup>&#x2122;</sup></a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><span>в наличии</span></div><img src="/assets/images/linoleum/tarkett-prestizh-texas-3.jpg" alt="Линолеум «Tarkett» Prestizh Texas 3"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_49?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_49 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_49?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Prestizh</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Название линолеума</td>
      <td class="body-item mbr-fonts-style display-7">Texas 3</td>
     </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">10,09</td>
     </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Высокая устойчивость</td>
     </tr><tr>
...
<p class="mbr-text mbr-fonts-style display-6" style="padding-top: 25px;"><a href="/assets/images/qr/linoleum/qr-code-tarkett-prestizh-texas-3.gif" download><img src="/assets/images/qr/linoleum/qr-code-tarkett-prestizh-texas-3.gif" alt="QR-код на линолеум «Tarkett» Prestizh Texas 3 магазина «СтройСити» в Стерлитамаке"  style="-webkit-user-select: none; float:left; margin: 0 10px 0 0;"></a> <i>Адрес: г. Стерлитамак, ул. Западная, д. 18Д</i><br><span style="text-align: center;">✆ <a class="text-primary" href="tel:+73473201102">+7&nbsp;(3473)&nbsp;201&nbsp;102</a> ✆ <a class="text-primary" href="tel:+79177779184">+7&nbsp;(917)&nbsp;777&nbsp;91&nbsp;84</a></span></p>
        </div>
          ...
          <div class="mbr-gallery-layout-default">
           <div>
            <div>
             ...
             <img src="/assets/images/linoleum/linolium-tarkett-v-magazibe-stroycity-1-min.jpg" alt="Линолеум «Tarkett» в магазине «СтройСити» фото №1" style="-webkit-user-select: none">
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/linolium-tarkett-v-magazibe-stroycity-1.jpg" alt="Линолеум «Tarkett» в магазине «СтройСити» фото №1" style="-webkit-user-select: none"></div>
...
<section class="order-form" id="buy">
 <div class="container">
  ...
  <div class="mbr-section-text mbr-white pb-3">
   ...
   <p class="mbr-text mbr-fonts-style display-6"><img src="/assets/images/qr/linoleum/qr-code-tarkett-prestizh-texas-3.gif" class="hide-on-mobile" alt="QR-код на линолеум «Tarkett» Prestizh Texas 3 магазина «СтройСити» в Стерлитамаке"  style="-webkit-user-select: none; float:left; margin: 0 10px 0 0;"> <i>Адрес: г. Стерлитамак, ул. Западная, д. 18Д</i><br><span style="text-align: center;">✆ <a class="text-primary" href="tel:+73473201102">+7&nbsp;(3473)&nbsp;201&nbsp;102</a> ✆ <a class="text-primary" href="tel:+79177779184">+7&nbsp;(917)&nbsp;777&nbsp;91&nbsp;84</a></span></p>
    </div>
   </div>
  </div>
 </div>
