...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Juteks» Forum Flint 1_007L полукоммерческий по цене от <?echo $min_price_lin_86?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Ютекс» Forum Flint 1_007L. Выберите и купите линолеум от <?echo $min_price_lin_86?> руб/м², цена зависит от ширины. Ширина линолеума: 2,5; 3,0; 3,5; 4,0 метра.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-juteks-linoleum-forum-flint-1-007l.webp);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(44, 10, 0);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«Juteks» Forum Flint 1_007L</h1>
      <h2 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">Купить линолеум <a href="#price"><span class="color-die"><img async src="/assets/images/juteks-logo.png" alt="«Juteks» — российский производитель напольных покрытий" style="margin-top: -2px;height: 40px;"></span></a> Российского производителя</h2>
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий<br>линолеум «Juteks» из коллекции Forum шириной: <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-juteks">Линолеум</a> / Линолеум «Juteks» Forum Flint 1_007L</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Juteks» <span style="font-size:1.7rem;">Forum Flint 1_007L</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_86?></span> <span>Страна: Россия </span> <span>Производитель: <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_86?></span></div><img src="/assets/images/linoleum/juteks-forum-flint-1-007l.webp" alt="Линолеум «Juteks» Forum Flint 1_007L"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_86?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_86 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_86?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Flint 1_007L</td>
     </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Имитация дерево</td>
     </tr><tr>
 ...
 <div style="padding-top: 10px;"><a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table">
    ...
    </div><p class="mbr-fonts-style panel-text display-6 pt-3 pb-2">В магазине «СтройСити» в Стерлитамаке, продается полукоммерческий <strong>линолеум «Juteks» Forum Flint 1_007L</strong> по цене от <?echo $min_price_lin_86?> до <?echo $max_price_lin_86?> руб/м² в зависимости от выбранной вами ширины линолеума. В наличии ширина <span class="alert-info">2,5</span> <span class="alert-info">3,0</span> <span class="alert-info">3,5</span> <span class="alert-info">4,0</span> метра. Срок службы линолеума 15 лет. Страна производитель Россия. У нас в магазине можно не только купить линолеум, но и заказать раской линолеума — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
<div class="youtube" id="w4PGUq9Y9tU" data-params="modestbranding=0&amp;showinfo=0&amp;controls=1&amp;vq=hd1080" data-image="../../../assets/images/video/linoleum-juteks-forum-flint-1-007l-video.webp" style="width: 100%; height: 608px; background-image: url(../../../assets/images/video/linoleum-juteks-forum-flint-1-007l-video.webp);"><div class="play"></div></div>
...
<p class="display-6">Соответствующая маркировка на линолеуме, как и на ламинате, имеет вид рисунка пиктограммы с изображением дома или человечков и цифры рядом с ними. Это служит подсказкой производителям, какой линолеум выбрать в том или ином случаи.</p>
...
.color-die:hover {background: rgb(255 255 255 / 84%);}
.color-the-die {padding: 0px 0px 1px 0px; background-color: rgb(49 45 40 / 52%); -webkit-border-radius: 15px; -moz-border-radius: 20px; -ms-border-radius: 20px; -o-border-radius: 20px; border-radius: 0.25rem;}
</style>
