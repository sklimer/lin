...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Ideal» Stream Pro White Oak 626M коммерческий от <?echo $min_price_lin_23?> ₽/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается коммерческий линолеум «Ютекс» Stream Pro White Oak 626M по цене от <?echo $min_price_lin_23?> ₽/м² в зависимости от выбранной ширины. Ширина линолеума: 1,5; 2,0; 2,5; 3,0; 3,5; 4,0 метра.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-ideal-juteks-linoleum-stream-pro-whiat-oak-626m.jpg);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(37, 46, 127);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум коммерческий<br>«IDEAL» Stream Pro White Oak 626M</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить коммерческий<br>линолеум «IDEAL» из коллекции Stream Pro шириной: <span class="otrez">1,5</span> <span class="otrez">2,0</span> <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-ideal">Линолеум</a> / Линолеум «Ideal» Stream Pro White Oak 626M</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «IDEAL» <span style="font-size:1.3rem;">Stream Pro White Oak 626M</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_23?></span> <span>Страна: Россия </span> <span>Бренд: <a class="text-black" href="/manufacturers/juteks#ideal" target="_blank">Ideal™</a> от <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_23?></span></div><img src="/assets/images/linoleum/ideal-juteks-stream-pro-whiat-oak-626m.jpg" alt="Линолеум «Ideal» Stream Pro White Oak 626M"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_23?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_23 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_23?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
          ...
          <table class="table"  >
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7" style="width: 48%;"><span class="narezka">1,5</span> <span class="narezka">2,0</span> <span class="narezka">2,5</span> <span class="narezka">3,0</span> <span class="narezka">3,5</span> <span class="narezka">4,0</span></td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Цифра 23 означает класс применения «бытовой», с высокой степени нагрузки (вторая цифра 3). Цифра 33 означает класс применения «полукоммерческий», с высокой степени нагрузки (вторая цифра 3). Цифра 42 означает класс применения «коммерческий», со средней степени нагрузки (вторая цифра 2)."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Класс применения</td>
              <td class="body-item mbr-fonts-style display-7">23, 33, 42</td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7">2,8 мм</td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7">0,65 мм</td>
             </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Stream Pro</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Название линолеума</td>
      <td class="body-item mbr-fonts-style display-7">White Oak 626M</td>
     </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Вес 1 м<sup>2</sup></td>
      <td class="body-item mbr-fonts-style display-7">2,7&nbsp;кг</td>
     </tr>
    </tbody>
   </table>        
</div>
 ...
 <div style="padding-top: 10px;"><a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table"  >
    ...
    </div><p class="mbr-fonts-style panel-text display-6" style="padding-top: 30px;">В магазине «СтройСити» в Стерлитамаке, продается коммерческий <strong>линолеум «iDEAL» Stream Pro White Oak 626M</strong>, страна производителя Россия. Срок службы 15 лет. Стоимость линолеума зависит от выбранной вами ширины и продаётся от <nobr><?echo $min_price_lin_23?> до <?echo $max_price_lin_23?></nobr> руб/м². Действующие ширины в наличии — <span class="alert-info">1,5</span> <span class="alert-info">2,0</span> <span class="alert-info">2,5</span> <span class="alert-info">3,0</span> <span class="alert-info">3,5</span> <span class="alert-info">4,0</span> метра. У нас в магазине можно не только купить линолеум, но и заказать раской, либо отрез по имеющимся размерам — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
<div class="youtube" id="Qxlx1bYRA_M" data-params="modestbranding=0&amp;showinfo=0&amp;controls=1&amp;vq=hd1080" data-image="../../../assets/images/video/linoleum-ideal-stream-pro-whiat-oak-626m-video.jpg" style="width: 100%; height: 608px; background-image: url(../../../assets/images/video/linoleum-ideal-stream-pro-whiat-oak-626m-video.jpg);"><div class="play"></div></div>
