...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Ideal» Stars Pure Oak 7182 полукоммерческий по цене <?echo $min_price_lin_21?> ₽/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Идеал» Stars Pure Oak 7182. Ширина линолеума: 5,0 метра.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-ideal-juteks-linoleum-stars-pure-oak-7182.jpg);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(37, 46, 127);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«IDEAL» Stars Pure Oak 7182</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий<br>линолеум «IDEAL» из коллекции Stars шириной: <span class="otrez">5,0</span> метра.</p>
...
<div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-ideal">Линолеум</a> / Линолеум «Ideal» Stars Pure Oak 7182</p>
<div class="media-container-row">
<div class="col-12 col-md-12">
<div class="media-container-row">
<div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «IDEAL» <span style="font-size:1.3rem;">Stars Pure Oak 7182</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_21?></span> <span>Страна: Россия </span> <span>Бренд: <a class="text-black" href="/manufacturers/juteks#ideal" target="_blank">Ideal<sup>&#x2122;</sup></a> от <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 10 лет</span>
...
<div class="coupon"><?echo $in_stock_lin_21?></div><img src="/assets/images/linoleum/ideal-juteks-stars-pure-oak-7182.jpg" alt="Линолеум «Ideal» Stars Pure Oak 7182"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_21?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_21 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_21?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
          ...
          <table class="table">
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7" style="width: 48%;"><span class="narezka">5,0</span></td>
             </tr><tr>
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Цифра 32 означает класс применения «полукоммерческий», со средней степени нагрузки (вторая цифра 2). Цифра 41 означает класс применения «для производственных помещений», с низкой степени нагрузки (вторая цифра 1). Достаточно прочный линолеум в исполении Stars Pure Oak 7182."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Класс применения</td>
              <td class="body-item mbr-fonts-style display-7">32, 41</td>
             </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Stars</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Название линолеума</td>
      <td class="body-item mbr-fonts-style display-7">Pure Oak 7182</td>
     </tr><tr>
      ...
      <td class="body-item mbr-fonts-style display-7">PU Guard Protection (лак)</td>
     </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Гетерогенные — это многослойные покрытия. У гетерогенного линолеума рисунок расположен на одном из слоев. Гомогенные — покрытия имеет один слой. У гомогенного линолеума рисунок нанесен на весь слой, поэтому не стирается со временем."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Структура</td>
      <td class="body-item mbr-fonts-style display-7">Гетерогенная</td>
     </tr><tr>
      ...
      <td class="body-item mbr-fonts-style display-7">Текстильная</td>
     </tr><tr>
...
<p class="mbr-fonts-style panel-text display-6 pt-3">В магазине «СтройСити» в Стерлитамаке, продается полукоммерческий <strong>линолеум «Ideal» Stars Pure Oak 7182</strong>, цена <?echo $min_price_lin_21?> руб/м², ширина в наличии <span class="alert-info">5,0</span> метров. Бесплатно отрезаем и раскраиваем по требуемым размерам. Срок службы линолеума 10 лет. Страна производитель Россия. У нас в магазине можно не только купить линолеум, но и заказать раской линолеума — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
