...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Juteks» Flash Liverpool 3 бытовой от <?echo $min_price_lin_30?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается бытовой линолеум «Ютекс» Flash Liverpool 3. Выберите и купите линолеум от <?echo $min_price_lin_30?> руб/м², цена зависит от ширины. Ширина линолеума: 1,5; 2,5; 3,0; 3,5; 4,0 метра.">
  <meta name="keywords" content="линолеум Juteks, линолеум Flash Liverpool 3, купить линолеум, ютекс, линолеум стерлитамак, линолеум цена">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/bg-juteks-linoleum-juteks-flash-liverpool-3.webp">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/bg-juteks-linoleum-juteks-flash-liverpool-3.webp">
  <meta name="twitter:image" content="https://str.city/assets/images/linoleum/bg-juteks-linoleum-juteks-flash-liverpool-3.webp">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/juteks-flash-liverpool-3.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/juteks-flash-liverpool-3.jpg">
  <meta property="og:image" content="https://str.city/assets/images/video/linoleum-juteks-flash-liverpool-3-video.jpg">
  <link rel="image_src" href="https://str.city/assets/images/video/linoleum-juteks-flash-liverpool-3-video.jpg">
  <meta property="og:image" content="https://str.city/assets/images/linoleum/linoleum-juteks-flash-liverpool-3-1.jpg">
  <link rel="image_src" href="https://str.city/assets/images/linoleum/linoleum-juteks-flash-liverpool-3-1.jpg">
  <meta property="og:title" content="Линолеум «Juteks» Flash Liverpool 3 бытовой от 343,00 руб/м² в Стерлитамаке">
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://str.city/linoleum/juteks-flash-liverpool-3">
  <meta property="og:description" content="Магазин «СтройСити» в Стерлитамаке продает бытовой линолеум «Ютекс» Flash Liverpool 3. Выберите и купите линолеум от <?echo $min_price_lin_30?> руб за 1 м², цена зависит от ширины. Ширина линолеума: 1,5; 2,5; 3,0; 3,5; 4,0 метра">
  <meta name="robots" content="index, follow">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="theme-color" content="#2b58cc">
  <link rel="canonical" href="https://str.city/linoleum/juteks-flash-liverpool-3">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-juteks-linoleum-juteks-flash-liverpool-3.webp);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(6 2 1);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум бытовой<br>«Juteks» Flash Liverpool 3</h1>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-juteks">Линолеум</a> / Линолеум «Juteks» Flash Liverpool 3</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Juteks» <span style="font-size:1.7rem;">Flash Liverpool 3</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_30?></span> <span>Страна: Россия </span> <span>Производитель: <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 10 лет</span>
...
<div class="coupon"><span>в наличии</span></div><img src="/assets/images/linoleum/juteks-flash-liverpool-3.jpg" alt="Линолеум «Juteks» Flash Liverpool 3" style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_30?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_30 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_30?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Liverpool 3</td>
     </tr><tr>
   ...
   <table class="table"  >
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Дерево</td>
     </tr><tr>
 ...
 <div style="padding-top: 10px;"><a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table"  >
    ...
    </div><p class="mbr-fonts-style panel-text display-6" style="padding-top: 30px;">В магазине «СтройСити» в Стерлитамаке, продается бытовой <strong>линолеум «Juteks» Flash Liverpool 3</strong> по цене от <?echo $min_price_lin_30?> до <?echo $max_price_lin_30?> руб/м² в зависимости от выбранной вами ширины. Страна производитель Россия. Срок службы линолеума 10 лет. У нас в магазине можно купить не только линолеум «Juteks» Flash Liverpool 3 шириной от 1,5 до 4,0 метров, но и заказать раской — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
<div class="youtube" id="3Bh5WuoA_3Q" data-params="modestbranding=0&amp;showinfo=0&amp;controls=1&amp;vq=hd1080" data-image="../../../assets/images/video/linoleum-juteks-flash-liverpool-3-video.jpg" style="width: 100%; height: 608px; background-image: url(../../../assets/images/video/linoleum-juteks-flash-liverpool-3-video.webp);"><div class="play"></div></div>
          ...
          <div class="mbr-gallery-layout-default">
           <div>
            <div>
             ...
             <img src="/assets/images/linoleum/linoleum-juteks-flash-liverpool-3-1-min.jpg" alt="Линолеум «Juteks» в магазине «СтройСити» фото №1" style="-webkit-user-select: none">
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/linoleum-juteks-flash-liverpool-3-1.jpg" alt="Линолеум «Juteks » в магазине «СтройСити» фото №1" style="-webkit-user-select: none"></div>
