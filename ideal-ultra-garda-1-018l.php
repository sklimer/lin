...
<head>
  ...
  <title>Линолеум «Ideal» Ultra Garda 1_018L полукоммерческий, цена от <?echo $min_price_lin_5?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий линолеум «Идеал» Ultra Garda 1_018L, цена от <?echo $min_price_lin_5?> до <?echo $max_price_lin_5?> руб/м² в зависимости от выбранной ширины ролика. Ширина линолеума: 1,5; 2,0; 2,5; 3,0; 3,5; 4,0 метра, толщина покрытия 4,8 мм, а защитный слой составляет 0,5 мм.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-ideal-juteks-linoleum-ideal-ultra-garda-1-018l.jpg);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(43 88 204);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«iDEAL» Ultra Garda 1_018L</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий<br>линолеум «IDEAL» из коллекции Stars шириной: <span class="otrez">1,5</span> <span class="otrez">2,0</span> <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-ideal">Линолеум</a> / Линолеум «Ideal» Ultra Garda 1_018L</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «iDEAL» Ultra Garda 1_018L</h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_5?></span> <span>Страна: Россия </span> <span>Бренд: <a class="text-black" href="/manufacturers/juteks#ideal" target="_blank">Ideal™</a> от <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_5?></span></div><img src="/assets/images/linoleum/ideal-juteks-ultra-garda-1-018l.jpg" alt="Линолеум «Ideal» Ultra Garda 1_018L"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_5?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_5 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_5?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
...
<section class="section-table table1" style="padding-top: 30px;">
          ...
          <table class="table">
            ...
            <tbody>
             <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><span class="textaddrs" data-title="Цифра 32 означает класс применения «полукоммерческий», со средней степени нагрузки (вторая цифра 2). Цифра 23 классифицируется как «бытовой» с наивысшей степенью нагрузки по типу помещения — это вторая цифра 3."><span class="mbri-question mbr-iconfont mbr-iconfont-btn"></span></span> Класс применения</td>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Garda 1_018L</td>
     </tr><tr>
 ...
 <div class="pt-2">
 <a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Технические свойства</span></a>
  <div class="spoilers_body">
   <table class="table">
    <thead>
     <tr class="table-heads">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">2,6&nbsp;кг</td>
     </tr>
    </tbody>
   </table>        
  </div>
 ...
 <div class="pt-2">
 <a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Устойчивость к воздействию</span></a>
  <div class="spoilers_body">
   <table class="table">
    <thead>
     <tr class="table-heads">
 ...
 <div class="pt-2">
 <a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table">
    <thead>
     <tr class="table-heads">
