...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Ideal» Ultra Country Oak 1_007L полукоммерческий от <?echo $min_price_lin_3?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Ютекс» Ultra Country Oak 1_007L. Ширина линолеума: 1,5; 2,0; 2,5; 3,0; 3,5; 4,0 метра. Цена от <?echo $min_price_lin_49?> руб/м² и зависит от выбора ширины">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/bg-ideal-juteks-linoleum-ultra-tisa-7070.jpg);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(2, 2, 2);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«IDEAL» Ultra Country Oak 1_007L</h1>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-ideal">Линолеум</a> / Линолеум «Ideal» Ultra Country Oak 1_007L</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «IDEAL» Ultra <span style="font-size:20px">Country Oak 1_007L</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_3?></span> <span>Страна: Россия </span> <span>Бренд: <a class="text-black" href="/manufacturers/juteks#ideal" target="_blank">IDEAL™</a> от <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 15 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_3?></span></div><img src="/assets/images/linoleum/ideal-ultra-country-oak-1-007l.jpg" alt="Линолеум «Ideal» Ultra Country Oak 1_007L"  style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_3?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_3 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_3?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Country Oak 1_007L</td>
     </tr><tr>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Антистатическое покрытие</td>
      <td class="body-item mbr-fonts-style display-7">Нет</td>
     </tr><tr>
      <td class="body-item mbr-fonts-style display-7">Основа</td>
      <td class="body-item mbr-fonts-style display-7">Утеплённая</td>
     </tr><tr>
 ...
 <div style="padding-top: 10px;"><a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table">
    ...
    </div><p class="mbr-fonts-style panel-text display-6 pt-3">В магазине «СтройСити» в Стерлитамаке, продается полукоммерческий <strong>линолеум «iDEAL» Ultra Country Oak 1_007L</strong>, цена от <?echo $min_price_lin_3?> до <?echo $max_price_lin_3?> руб/м², в зависимости от выбора ширины ролика. Ширины в наличии <span class="alert-info">1,5</span> <span class="alert-info">2,0</span> <span class="alert-info">2,5</span> <span class="alert-info">3,0</span> <span class="alert-info">3,5</span> <span class="alert-info">4,0</span> метра. Срок службы линолеума 15 лет. Страна производителя Россия. У нас в магазине можно не только купить линолеум, но и заказать раской линолеума — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
...
<p class="mbr-fonts-style panel-text display-6">Компания под брендом IDEAL — это известный производитель напольных покрытий, и линолеум IDEAL может отличаться высоким качеством, устойчивостью к истиранию, надежностью и приятным внешнем видом. Однако, выбор конкретного типа линолеума должен производиться с учётом особенностей помещения, где он будет уложен, а также ожиданиями от эксплуатации.</p>
 ...
 <div class="container">
  <div class="media-container-row">
   <div class="mbr-figure" style="width: 100%; padding-left: 15px;">
    <h2 class="mbr-section-title mbr-black pb-3 mbr-fonts-style display-2">Заказать линолеум «<span class="textaddr" data-title="Для отечественного дистрибьютора покрытий для пола и стен, группе компаний «Опус», компания «Juteks» производит напольное ПВХ-покрытие, в частности линолеум. Линолеум группы компаний «Опус» представлен под брендом «IDEAL» в разных вариаций коллекций.">IDEAL</span>»</h2>
    <? echo $orderform; ?>
   </div>
  <div class="media-content">
   <h2 class="mbr-section-title mbr-black pb-2 mbr-fonts-style display-2">Как купить линолеум «IDEAL»?</h2>
  <div class="mbr-section-text mbr-white pb-3">
   <p class="mbr-text mbr-fonts-style display-6">В поле формы заказа укажите имя, телефон, сообщение, проверочный код и нажмите отправить. Будьте уверены, мы знаем, ваш выбор — <strong>линолеум «Juteks» Ultra Country Oak 1_007L</strong>.</p><p class="mbr-text mbr-fonts-style display-6">Оперативно <span class="textaddr" data-title="Не забудьте указать требуемую ширину линолеума и его длину.">подготовим</span> информацию по заказу или заданному вопросу и уже сегодня <span class="textaddr" data-title="Перезвоним в рабочее время. Если посчитаем нужным, можем связаться и не в рабочее. В любом случае, оставленный заказ через форму, обрабатывается нами в течение 60 секунд."><?php echo date("d.m.Y");?></span> перезвоним к вам.</p>
