...
<?php include $_SERVER['DOCUMENT_ROOT']. "/config/config-data-all-lin.php"; ?>
  ...
  <title>Линолеум «Juteks» Forward Columb OAK 11 полукоммерческий цена от <?echo $min_price_lin_32?> руб/м² купить в Стерлитамаке</title>
  <meta name="description" content="В магазине «СтройСити» в Стерлитамаке продается полукоммерческий линолеум «Ютекс» Forward Columb OAK 11. Выберите и купите линолеум стоимостью от <?echo $min_price_lin_32?> руб/м², цена зависит от ширины. Ширина линолеума: 1,0; 1,5; 2,5; 3,0; 3,5; 4,0 метра.">
...
<? echo $navigation; ?>
<section class="header1 head1 mbr-parallax-background" id="header1-m" style="background-image: url(../../../assets/images/linoleum/forward/bg-juteks-linoleum-forward-columb-oak-11.webp);">
 <div class="mbr-overlay" style="opacity: 0.3; background-color: rgb(6 2 1);">
  </div>
   <div class="container">
    <div class="row justify-content-md-center">
     <div class="mbr-white col-md-12">
      <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Линолеум полукоммерческий<br>«Juteks» Forward Columb OAK 11</h1>
      ...
      <p class="mbr-text align-center pb-3 mbr-fonts-style display-9">В магазине «СтройСити» в Стерлитамаке предлагаем купить полукоммерческий<br>линолеум «Juteks» из коллекции Forward шириной: <span class="otrez">1,0</span> <span class="otrez">1,5</span> <span class="otrez">2,5</span> <span class="otrez">3,0</span> <span class="otrez">3,5</span> <span class="otrez">4,0</span> метра.</p>
...
<section class="product1" id="price">
    <div class="container"><p class="display-7" style="padding-left: 15px;"><a class="text-black" href="/">Главная</a> / <a class="text-black" href="/catalog/">Каталог</a> / <a class="text-black" href="/linoleum/#catalog-juteks">Линолеум</a> / Линолеум «Juteks» Forward Columb OAK 11</p>
        <div class="media-container-row">
            <div class="col-12 col-md-12">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 100%; padding-top: 30px;">
<h2 class="mbr-section-title mbr-black pb-0 mbr-fonts-style display-2">Линолеум «Juteks» <span style="font-size:1.3rem;">Forward Columb OAK 11</span></h2>
<div class="code">
<p class="display-8"><span>Артикул: <?echo $art_lin_32?></span> <span>Страна: Россия </span> <span>Производитель: <a class="text-black" href="/manufacturers/juteks" target="_blank">Juteks™</a></span> <span>Срок службы: 10 лет</span>
...
<div class="coupon"><span><?echo $in_stock_lin_32?></span></div><img src="/assets/images/linoleum/juteks-forward-columb-oak-11.webp" alt="Линолеум «Juteks» Forward Columb OAK 11" style="-webkit-user-select: none">
<div class="mbr-section-btn pt-3 align-center">
<a href="" class="btn btn-sm btn-success display-6 spoilers_links"><span class="mbri-touch mbr-iconfont mbr-iconfont-btn"></span> <span style="border-bottom: 1px dotted #4d90fe;">Цена <?echo $min_price_lin_32?>&#8201;&#8381;</span></a>
<div class="spoilers_body">
<p class="display-6" style="padding-top: 10px;">
<?php foreach( $price_32 as $value ){if ($value[0]){echo'<br>Цена: '.$value[0].' ₽ '.'(ширина '.$value[1].' м, артикул: '.$value[2].')';}}?>
</p>
</div>
<a class="btn btn-sm btn-secondary display-6" href="#buy"><span class="mbri-idea mbr-iconfont mbr-iconfont-btn"></span> Заказать</a>
<p class="display-8"><sup>∗</sup><span class="textaddr" data-title="Нажмите ↑ на цену, чтобы посмотреть стоимость нужной ширины линолеума.">Цена</span> линолеума указана за 1 м², в зависимости от ширины.<br>Обновлено: <?echo $up_date_lin_32?> &gt; Сегодня: <?php echo date("d.m.Y");?></p>
</div></div>
   ...
   <table class="table">
    ...
    <tbody>
     <tr> 
      ...
      <td class="body-item mbr-fonts-style display-7">Columb OAK 11</td>
     </tr><tr>
 ...
 <div style="padding-top: 10px;"><a class="spoilers_links" href=""><span style="border-bottom: 1px dotted #4d90fe;">Экологическая безопасность</span></a>
  <div class="spoilers_body">
   <table class="table">
    ...
    </div><p class="mbr-fonts-style panel-text display-6 pt-3">В магазине «СтройСити» в Стерлитамаке, продается полукоммерческий <strong>линолеум «Juteks» Forward Columb OAK 11</strong> по цене от <?echo $min_price_lin_32?> до <?echo $max_price_lin_32?> руб/м² в зависимости от выбранной вами ширины линолеума. Ширины в наличии <span class="alert-info">1,0</span> <span class="alert-info">1,5</span> <span class="alert-info">2,0</span> <span class="alert-info">2,5</span> <span class="alert-info">3,0</span> <span class="alert-info">3,5</span> <span class="alert-info">4,0</span> метра Страна производитель Россия. Срок службы линолеума 10 лет. У нас в магазине можно не только купить линолеум, но и заказать раской линолеума — это бесплатная услуга. В магазине представлено большое разнообразие бытового, полукоммерческого и коммерческого линолеума. Цветовая гамма и разнообразие дизайна, позволит выбрать наилучшее и подходящее решение.</p>
<p class="mbr-fonts-style panel-text display-6">Рекомендуем при просмотре выставлять качество видео <nobr>1080p60 HD</nobr>.</p>
<div class="youtube" id="ArOIxPqWCmI" data-params="modestbranding=0&amp;showinfo=0&amp;controls=1&amp;vq=hd1080" data-image="../../../assets/images/video/linoleum-juteks-forward-columb-oak-11-video.webp" style="width: 100%; height: 608px; background-image: url(../../../assets/images/video/linoleum-juteks-forward-columb-oak-11-video.webp);"><div class="play"></div></div>
          ...
          <div class="mbr-gallery-layout-default">
           <div>
            <div>
             ...
             <img src="/assets/images/linoleum/linoleum-juteks-forward-columb-oak-11-1-min.webp" alt="Линолеум «Juteks» Forward Columb OAK 11 фото №1" style="-webkit-user-select: none">
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/forward/linoleum-juteks-forward-columb-oak-11-1.webp" alt="Линолеум «Juteks» Forward Columb OAK 11 фото №1" style="-webkit-user-select: none"></div>
          ...
          <div class="mbr-gallery-layout-default">
           <div>
            <div>
             ...
             <img src="/assets/images/linoleum/forward/linoleum-juteks-forward-columb-oak-11-v-interere-spalny-min.jpg" alt="Линолеум «Juteks» Forward Columb OAK 11 в интерьере спальной комнаты" style="-webkit-user-select: none">
             <span class="icon-focus"></span>
...
<!-- Lightbox -->
          ...
          <div class="modal-body">
           <div class="carousel-inner">
            <div class="carousel-item"><img src="/assets/images/linoleum/forward/linoleum-juteks-forward-columb-oak-11-v-interere-spalny.jpg" alt="Линолеум «Juteks» Forward Columb OAK 11 в интерьере спальной комнаты" style="-webkit-user-select: none"></div>
